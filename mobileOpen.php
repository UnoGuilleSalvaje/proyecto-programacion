...
<section id="mobile-nav" class="mobile-nav" data-top-component="mobile-nav" data-page-position="nav">
    <div class="mobile-nav__container">
        <a href="#" class="mobile-nav__open" aria-label="open navigation" role="button"
            tabindex="0">
...
<div class="menu-nav opening active"><a href="index.php" class="nav-close main-close" aria-label="close navigation"
        role="button" tabindex="0"><span class="icon--svg icon--svg--white-stroke" aria-hidden="true"><svg
    ...
    <div class="menu-nav__scroller">
        <div class="menu-nav-container">
            <nav class="menu-nav__links">
                <ul>
                    <li><a href="index.php"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="News" role="button"
                            tabindex="0">Inicio<span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg>
                            </span></button></a></li>
                    <li><a href="tienda.php"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="Comics" role="button"
                            tabindex="0">Películas<span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a></li>
                    <li><a href=""><button href="#" class="menu-nav__item menu-nav__item--open" data-section="Characters"
                            role="button" tabindex="0">GÉNEROS<span
                                class="icon--svg icon--svg--red-stroke icon--arrow" aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="11" height="16" viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a> <ul>
        <!-- Nuevo apartado 1 -->
        <li><a href="mostrar_peliculas.php?genero=Accion" style="color:#ffff;">ACCIÓN</a></li>

        <!-- Nuevo apartado 2 -->
        <li><a href="mostrar_peliculas.php?genero=Comedia" style="color:#ffff;" >COMEDIA</a></li>

        <!-- Nuevo apartado 3, y así sucesivamente -->
        <li><a href="mostrar_peliculas.php?genero=Drama" style="color:#ffff;">DRAMA</a></li>
    </ul>
</li>
                    <li><a href="a"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="Movies" role="button"
                            tabindex="0">Productos<span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a></li>
                    <li><a href="about/AboutPage/about.php"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="TV Shows"
                            role="button" tabindex="0">Acerca de <span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a></li>
                    <li><a href="ayuda.php"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="Games" role="button"
                            tabindex="0">Ayuda<span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a></li>
                    <li><a href="Contactanos/index.php"><button href="#" class="menu-nav__item menu-nav__item--open" data-section="Videos" role="button"
                            tabindex="0">Contáctanos<span class="icon--svg icon--svg--red-stroke icon--arrow"
                                aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="16"
                                    viewBox="0 0 11 16">
                                    <path fill="none" d="M-.851-3L9.232 8-2.75 21.071"></path>
                                </svg></span></button></a>
        ...
        <div class="menu-nav-container user-menu"><a>
                <div class="menu-nav__title">Gands Movies</div>
            </a>
            <nav class="user-links">
                <ul id="mvl-user-menu__mobile" class="user-menu" data-enable-one-id-modal="true">
                    <li class="menu-nav__li menu-nav__li--logged-out"><a
                            class="menu-nav__item menu-nav__item-no-menu mvl__referer-link mobile-sign-in"
                            href="">INICIAR SESIÓN </a></li>
                    <li class="menu-nav__li menu-nav__li--logged-out"><a
                            class="menu-nav__item menu-nav__item-no-menu mvl__referer-link mobile-sign-up"
                            href="">REGISTRARSE</a>
                    </li>
                </ul>
            </nav>
        ...
        <div class="menu-nav-container">
            <div class="social-links mvl-flyout__social"><a target="_blank"
                    aria-label="follow us on Facebook, opens a new window" class="mvl-flyout__social__img"
                    href="https://www.facebook.com/profile.php?id=61551065917242"><span class="icon--svg icon--svg--gray-fill icon--facebook "
                        aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                            viewBox="0 0 18 18">
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Twitter, opens a new window"
                    class="mvl-flyout__social__img" href="https://twitter.com/Marvel"><span
                        class="icon--svg icon--svg--gray-fill icon--twitter" aria-hidden="true"><svg
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Instagram, opens a new window"
                    class="mvl-flyout__social__img" href="https://instagram.com/gandsmovies?igshid=MTNiYzNiMzkwZA%3D%3D&utm_source=qr"><span
                        class="icon--svg icon--svg--gray-fill" aria-hidden="true"><svg
                            xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                            <path fill-rule="evenodd"
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Tumblr, opens a new window"
                    class="mvl-flyout__social__img" href="http://marvelentertainment.tumblr.com"><span
                        class="icon--svg icon--svg--gray-fill" aria-hidden="true"><svg
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Youtube, opens a new window"
                    class="mvl-flyout__social__img" href="http://www.youtube.com/channel/UCvC4D8onUfXzvjTOM-dBfEA"><span
                        class="icon--svg icon--svg--gray-fill" aria-hidden="true"><svg
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Snapchat, opens a new window"
                    class="mvl-flyout__social__img" href="https://www.snapchat.com/add/marvel"><span
                        class="icon--svg icon--svg--gray-fill" aria-hidden="true"><svg
                        ...
                        </svg></span></a><a target="_blank" aria-label="follow us on Pinterest, opens a new window"
                    class="mvl-flyout__social__img" href="https://www.pinterest.com/marvelofficial"><span
                        class="icon--svg icon--svg--gray-fill" aria-hidden="true"><svg
        ...
        <div class="menu-nav-container menu-nav-container_noborder promo-links promo-links__main">
            <div class="promo-links__item"><a class="promo-links__callout"
                    href="/insider?cid=Dcom_navigation_20200929_insider_more">
                    <div class="promo-links__callout-img-container">
                        <figure class="img__wrapper "><img
                                src="media/U.png"
                                class="promo-links__callout-image"></figure>
                    </div>
                    <div class="promo-links__callout-text">
                        <h3 class="promo-links__callout-title">ÚNETE A NOSOTROS</h3>
                        <h4 class="promo-links__callout-description-1">Crea tu portal para explorar emociones intensas</h4>
                    </div>
                </a></div>
            <div class="promo-links__item"><a class="promo-links__callout"
                    href="/unlimited?cid=dcom_navigation_20220712_unlimited_more">
                    <div class="promo-links__callout-img-container">
                        <figure class="img__wrapper"><img
                                src="media/E.png"
                                alt="Marvel Unlimited Logo" class="promo-links__callout-image" style="height: 60px; with: 60px;"></figure>
                    </div>
                    <div class="promo-links__callout-text">
                        <h3 class="promo-links__callout-title">ENCUENTRA LA MAGIA EN CADA PANTALLA</h3>
                        <h4 class="promo-links__callout-description-1">Encuentra +300 películas disponibles</h4>
                    </div>
                </a></div>
        </div>
    </div>
    ...
    ?>
                ...
                <div id="page-content" class="page__contents -page">
                    ...
                    <section id="masthead-2" class="page__component page__component-- page__component--masthead section__color__light ">
                        ...
                        <!--AQUÍ INICIA EL CARRRUSEL DE  BOOTSTRAP-->
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="media/gands.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="media/fondoOscuro1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="media/1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="media/top.png" class="d-block w-100" alt="...">
    </div>
                            ...
                            <div class="social-links-wrapper">
                                <div class="social-links social">
                                    <div class="social__title">Síguenos</div><a target="_blank"
                                        ...
                                        href="https://instagram.com/gandsmovies?igshid=MTNiYzNiMzkwZA%3D%3D&utm_source=qr"><span class="icon--svg"
                                            aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                height="18" viewBox="0 0 18 18">
                                                <path fill-rule="evenodd"
                                                    d="M15.441 15.993H2.206a.552.552 0 01-.552-.552V7.17H3.86c-.287.414-.384 1.185-.384 1.675 0 2.953 2.408 5.356 5.368 5.356 2.96 0 5.368-2.403 5.368-5.356 0-.49-.069-1.25-.425-1.675h2.206v8.272a.552.552 0 01-.552.552M8.844 5.458a3.39 3.39 0 013.394 3.386 3.39 3.39 0 01-3.394 3.386A3.39 3.39 0 015.45 8.844a3.39 3.39 0 013.393-3.386m4.391-3.252h1.655c.304 0 .551.247.551.551v1.655a.552.552 0 01-.551.551h-1.655a.552.552 0 01-.551-.551V2.757c0-.304.247-.551.551-.551M15.55 0H2.098A2.095 2.095 0 000 2.093v13.461c0 1.156.94 2.093 2.098 2.093h13.451a2.095 2.095 0 002.098-2.093V2.093C17.647.937 16.707 0 15.549 0">
                        ...
                        <div class="sets base_sets half ">
                            <div class="sets__hero">
                                <div class="sets__bg__container">
                                    <figure class="img__wrapper sets__background__wrapper">
                                        <div class="built__background built__background--single sets__background use-vars"
                                            style="background-image:url(media/pantalla.webp) !important ">
                                        </div>
                                    </figure>
                                </div>
                                <div class="mobile_tab"><button class="baseCarousel__arrow base_sets__arrow left "
...
<ul class="social-links footer__social">
    ...
    <li class="footer__social__img"><a target="_blank"
            ...
            href="https://instagram.com/gandsmovies?igshid=MTNiYzNiMzkwZA%3D%3D&utm_source=qr.instagram.com/"><span
