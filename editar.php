...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Ejecuta la consulta
    if ($stmt->execute()) {
        echo "Datos de la película actualizados correctamente.";
    } else {
...
<form action="" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php // Coloca aquí el ID de la película ?>">
    <label for="nombre">Nombre:</label>
    <input type="text" name="nombre" value="<?php // Coloca aquí el nombre de la película ?>" required>

    <label for="descripcion">Descripción:</label>
    <textarea name="descripcion" required><?php // Coloca aquí la descripción de la película ?></textarea>

    <label for="cantidad_existencia">Cantidad en existencia:</label>
    <input type="number" name="cantidad_existencia" value="<?php // Coloca aquí la cantidad en existencia ?>" required>
    ...
    <input type="number" name="precio" step="0.01" value="<?php // Coloca aquí el precio ?>" required>

    <label for="imagen">Imagen:</label>
    <input type="file" name="imagen">
    <img src="path_to_image/<?php // Coloca aquí el path de la imagen ?>" alt="Imagen actual de la película">

    <label for="tiene_descuento">Tiene descuento:</label>
    <select name="tiene_descuento" required>
        <option value="0" <?php // Si no tiene descuento, imprime 'selected' ?>>No</option>
        <option value="1" <?php // Si tiene descuento, imprime 'selected' ?>>Sí</option>
    </select>

    <label for="descuento">Descuento:</label>
    <input type="number" name="descuento" step="0.01" value="<?php // Coloca aquí el descuento ?>">

    <label for="genero">Género:</label>
    <input type="text" name="genero" value="<?php // Coloca aquí el género ?>" required>
