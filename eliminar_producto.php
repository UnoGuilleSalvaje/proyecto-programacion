...
if ($producto): ?>
<form action="remove_movie.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id_producto" value="<?php echo $producto['id']; ?>">
    <label for="nombre">Nombre:</label>
    <input type="text" name="nombre" value="<?php echo htmlspecialchars($producto['nombre']); ?>" readonly>

    <label for="descripcion">Descripción:</label>
    <textarea name="descripcion" required readonly><?php echo htmlspecialchars($producto['descripcion']); ?></textarea>

    <label for="cantidad_existencia">Cantidad en existencia:</label>
    <input type="number" name="cantidad_existencia" value="<?php echo $producto['cantidad_existencia']; ?>" readonly>
    ...
    <input type="number" name="precio" step="0.01" value="<?php echo $producto['precio']; ?>" readonly>
    ...
    <input type="number" name="descuento" step="0.01" value="<?php echo $producto['descuento']; ?>" readonly>

    <label for="genero">Género:</label>
    <input type="text" name="genero" value="<?php echo $producto['genero']; ?>" readonly>

    <br><br>
    <input type="submit" name="editar_producto" value="Eliminar Producto">
</form>
<?php endif;
?>
